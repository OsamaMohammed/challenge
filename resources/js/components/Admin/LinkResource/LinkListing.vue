<template>
    <div>
        ...
        >
            ...
            <b-table-column label="Open in new tab" v-slot="props">
                <b-tooltip label="Open in new tab" v-if="props.row.new_tab">
                    <b-icon icon="open-in-new" type="is-success"></b-icon>
                </b-tooltip>
                <b-tooltip label="Open in same tab" v-else>
                    <b-icon icon="link" type="is-danger"></b-icon>
                </b-tooltip>
            </b-table-column>
            ...
            <b-table-column width="90" v-slot="props">
        ...
        <link-modal :active.sync="activeModal" :edit-item.sync="editItem" @success="loadTable" />
    </div>
</template>
